...
public static class ImHelper
{
    ...
    public static string PrevConnectServer(long clientId, string clientMetaData) => Instance.PrevConnectServer(clientId, clientMetaData);
    ...
    /// </summary>
    /// <returns></returns>
    public static IEnumerable<long> GetClientListByOnline() => Instance.GetClientListByOnline();
    ...
    /// </summary>
    /// <param name="clientId"></param>
    public static void ForceOffline(long clientId) => Instance.ForceOffline(clientId);
    ...
    public static void EventBus(
        ...
        Action<(long clientId, string clientMetaData)> offline) => Instance.EventBus(online, offline);
